...
function getValFromLocalStorage(valName) { // GLOABL
    let value = localStorage.getItem(valName)
    value = value != null ? (value === 'true') : 'unsetted'
    return value
  }
  
 //module.exports = { fetchPost, fetchGet, makeToast, setCookie, getCookie, deleteCookie, stringToType, loadScript, getUrlParameter, setUrlParameter, copyTextToClipboard, mySessionStorage, sleep, RandomString }
